...
def multiplayer_screen():
    ...
    while running:
        ...
        draw.draw_title(const.screen, const.black, "MULTIPLAYER")
        ...
        if novo_dugme:
            player_1_button = pygame.Rect(const.button_x - 230, const.button_y + 125, const.button_width,
                                          const.button_height)
            draw.draw_button(const.screen, const.blue, player_1_button, "Player 1 (X)", font, const.black)
            if player_1_button.collidepoint(mouse_pos):
                draw.draw_button(const.screen, const.hover_blue, player_1_button, "Player 1 (X)", font, const.black)
            ...
            player_2_button = pygame.Rect(const.button_x - 230, const.button_y + 210, const.button_width,
                                          const.button_height)
            draw.draw_button(const.screen, const.blue, player_2_button, "Player 2 (O)", font, const.black)
            if player_2_button.collidepoint(mouse_pos):
                draw.draw_button(const.screen, const.hover_blue, player_2_button, "Player 2 (O)", font, const.black)
                if event.type == pygame.MOUSEBUTTONDOWN:
                    if player:
                        player = False
